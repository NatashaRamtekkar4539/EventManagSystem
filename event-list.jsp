	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="container text-left">
				...
				<a href="<%=request.getContextPath()%>/new" class="btn btn-success">Add New Event</a>
			</div>
			<br>
				...
				<tbody>
					...
					<c:forEach var="event" items="${listEvent}">
						...
						<tr>
							...
							<td><a href="edit?id=<c:out value='${event.id}' />">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="delete?id=<c:out value='${event.id}' />">Delete</a></td>
						</tr>
					</c:forEach>
					<!-- } -->
				</tbody>
